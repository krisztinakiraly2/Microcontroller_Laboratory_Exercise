...
#define SCLK_PIN GLCD_E_Pin
#define SCLK_PORT GLCD_E_GPIO_Port
#define CS_PIN GLCD_DI_Pin
#define CS_PORT GLCD_DI_GPIO_Port
#define SID_PIN GLCD_RW_Pin
#define SID_PORT GLCD_RW_GPIO_Port
#define RST_PIN GLCD_RESET_Pin
#define RST_PORT GLCD_RESET_GPIO_Port
